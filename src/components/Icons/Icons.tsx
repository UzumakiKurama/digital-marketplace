...
export const Icons = {
    logo : (props : LucideProps) => (
        <svg {...props} className="h-14 w-14" viewBox="0 0 32 32" id="Layer_1" version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        <g>
            <g>
                <path 
                    style={{fill:"#00BBB4"}}
