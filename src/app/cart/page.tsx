                ...
                <div className={cn("lg:col-span-7", {
                    ...
                    {isMounted && items.length === 0 ? (
                        <div className="flex flex-col items-center justify-center space-y-1">
                            <div aria-hidden="true" className="relative mb-4 h-80 w-80 text-muted-foreground">
                                <Image
                                    fill 
                                    src="/assets/empty-shopping-cart.jpeg" 
                                    loading='eager' 
                                    ...
                                    <li key={product.id} className='flex py-6 sm:py-10'>
                                        ...
                                        <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                                            <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                                                ...
                                                <div className="flex justify-self-end mt-4 sm:mt-0 sm:pr-9 w-20">
                                                    <Button 
                    ...
                    <div className="mt-6 space-y-4">
                        ...
                        <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                            ...
                            <div className="text-sm font-medium text-gray-900">
                                {
                                    isMounted ? formatPrice(FEE) : <Loader2 className='h-4 w-4 text-muted-foreground' />
                                }
                            </div>
                        </div>
